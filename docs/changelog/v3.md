...
The notes below cover the v3 line, from the first v3 build to v3.10. V4 replaced the
v3 team model, but v3 built the player WAR model and the web app, and both still
ship. These notes were part of the root README until September 2026. File paths are
